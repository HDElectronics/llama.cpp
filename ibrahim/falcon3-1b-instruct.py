...
use_image = False  # Set to False to run with text only
...
if prompt_text:
    ...
    if use_image and image is not None:
        ...
        inputs = processor(
            text=[formatted_prompt], images=None, padding=True, return_tensors="pt"
        )
    ...
    print("Text prompt is required for inference.")
